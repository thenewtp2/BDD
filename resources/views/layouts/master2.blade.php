  ...
  <body class="size-1140">
    ...
    <header role="banner">    
      ...
      <nav class="background-white background-primary-hightlight">
        <div class="line">
          <div class="s-12 l-2">
            <a href="index.html" class="logo"><img src="https://static.vecteezy.com/system/resources/previews/001/107/289/non_2x/green-covid-19-text-vector.jpg" alt=""></a>
          </div>
          <br>
          <div class="top-nav s-12 l-10">
            <p class="nav-text"></p>
            <ul class="left chevron">
              <li><a href="{{url('acceiull')}}">Accueil</a></li>
              <li><a href="about.html">Je m'informe</a></li>
              
              <li><a href="{{url('idés/idee')}}">J'ai une idée</a></li>
               
              <li><a href="{{url('signals/denonce')}}">Je dénonce </a></li>
              
              <li><a href="{{url('Carte épidémiologique')}}">La carte épidimiologique</a></li>
